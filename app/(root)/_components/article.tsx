...
export const Article = ({ href, imageSrc, imageAlt, category, title, description }: ArticleProps) => {
    return (
        <Link href={href} className={styles.content__podcastBox_articles_link}>
            <Image width={50} height={50} src={imageSrc} alt={imageAlt} />
            <span className={styles.content__podcastBox_articles_link_category} style={{ backgroundColor: "purple" }}>
        {category}
      </span>
