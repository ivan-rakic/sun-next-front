      ...
      <main className={styles.content}>
        ...
        <section className={`${stylesRes.content_container} ${styles.content__podcastBox}`}>
          ...
          <div className={styles.content__podcastBox_articles}>
            <Link href='/podcast' className={styles.content__podcastBox_articles_link}>
              ...
              <span className={styles.content__podcastBox_articles_link_category}
                    style={{backgroundColor: 'purple'}}>nesto</span>
            ...
            <Link href='/podcast' className={styles.content__podcastBox_articles_link}>
              ...
              <span className={styles.content__podcastBox_articles_link_category}
                    style={{backgroundColor: 'orange'}}>nesto</span>
              <div className={styles.content__podcastBox_articles_link_titles}>
                <h5>Protraćeni životi irski: Tema za do 264 funte Sterlinga (300 evra po današnjem kursu)?</h5>
                <p>Elita vs Radništvo - Podeljeni grad Belfast i nacionalizam u Iraca</p>
              </div>
            ...
            <Link href='/podcast' className={styles.content__podcastBox_articles_link}>
              ...
              <span className={styles.content__podcastBox_articles_link_category}
                    style={{backgroundColor: 'darkblue'}}>nesto</span>
              <div className={styles.content__podcastBox_articles_link_titles}>
                <h5>Protraćeni životi irski: Tema za do 264 funte Sterlinga (300 evra po današnjem kursu)?</h5>
                <p>Elita vs Radništvo - Podeljeni grad Belfast i nacionalizam u Iraca</p>
              </div>
            ...
            <Link href='/podcast' className={styles.content__podcastBox_articles_link}>
              <Image src={img4} alt='test'/>
              <span className={styles.content__podcastBox_articles_link_category}
                    style={{backgroundColor: 'limegreen'}}>nesto</span>
              <div className={styles.content__podcastBox_articles_link_titles}>
                <h5>Protraćeni životi irski: Tema za do 264 funte Sterlinga (300 evra po današnjem kursu)?</h5>
                <p>Elita vs Radništvo - Podeljeni grad Belfast i nacionalizam u Iraca</p>
              </div>
            ...
            <Link href='/podcast' className={styles.content__podcastBox_articles_link}>
              <Image src={img1} alt='test'/>
              <span className={styles.content__podcastBox_articles_link_category}
                    style={{backgroundColor: 'red'}}>nesto</span>
              <div className={styles.content__podcastBox_articles_link_titles}>
                <h5>Protraćeni životi irski: Tema za do 264 funte Sterlinga (300 evra po današnjem kursu)?</h5>
                <p>Elita vs Radništvo - Podeljeni grad Belfast i nacionalizam u Iraca</p>
              </div>
        ...
        <section className={styles.content__donateContainer}>
          ...
          <div className={styles.content__donateContainer_content}>
            ...
            <p>
              Pozivamo Sunca zrake da podrže opstanak i rast našeg radija. Nemamo sponzore niti finansijere. Jedini od
              kojih hoćemo da zavisimo ste vi.
            </p>
            <Link href='/podrzi-sunce' className={styles.content__donateContainer_content_learnMoreButton}>Saznaj
              Više</Link>
            <Link href='https://www.paypal.com/paypalme/sunradiors' target='_blank'
                  className={styles.content__donateContainer_content_ppButton}>PayPal</Link>
            <Link href='https://www.patreon.com/sunradio' target='_blank'
                  className={styles.content__donateContainer_content_ptButton}>Patreon</Link>
          </div>
